...
RUN_ACTION_INSTRUCTIONS_CMD+=("${BIN_PHPENV} conf add ${BLD_PATH}/${RUN_ACTION_INSTRUCTIONS_PHP_INC}.ini")
RUN_ACTION_INSTRUCTIONS_CMD+=("${BIN_PHPENV} conf enable ${RUN_ACTION_INSTRUCTIONS_PHP_INC}")
