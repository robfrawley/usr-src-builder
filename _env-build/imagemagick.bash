...
RUN_CMD_WORKING_PATH=true

RUN_ACTION_INSTRUCTIONS_CMD=(
    "rm -fr $HOME/opt/imagemagick/ ImageMagick-$BLD_ENV_MAKE_VER_IMAGE_MAGIK/ ImageMagick-$BLD_ENV_MAKE_VER_IMAGE_MAGIK.tar.gz"
    "mkdir -p $HOME/opt/imagemagick/"
    "${BIN_CURL} -o ImageMagick-$BLD_ENV_MAKE_VER_IMAGE_MAGIK.tar.gz http://www.imagemagick.org/download/ImageMagick-$BLD_ENV_MAKE_VER_IMAGE_MAGIK.tar.gz"
    "tar xzf ImageMagick-$BLD_ENV_MAKE_VER_IMAGE_MAGIK.tar.gz --strip-components=1"
